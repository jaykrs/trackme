...
import com.teqto.trackme.model.UploadModel;
...
public class RestUploadController {
	...
	// @ResponseBody
	public ResponseEntity<?> uploadavatarFile(@RequestParam("file") MultipartFile file, @PathVariable("userId") String userId) {

	//	int moid = userService.getUser(Integer.parseInt(userId)).getManagementObject();
	//	ManagedObject mo = (ManagedObject) ManagedObjectService.getManagedObject(moid);
		...
		return new ResponseEntity<Object>("Successfully uploaded - " + file.getOriginalFilename(),
